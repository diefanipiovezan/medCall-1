...
@section('main')
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="pointer-events:none;">
                    {{-- TODO: Se der tempo colocar os totais... --}}
                    {{-- <div class="row">
                        <div class="col-md-9">
                            <span class="glyphicon glyphicon-time" aria-hidden="true" style="color:orange;"></span>&nbsp;Aguardando Aprovação
                        </div>
                        <div class="col-md-3">
                            <span class="badge" style="background:orange;">155</span>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                    ...
                    <p><span class="glyphicon glyphicon-remove" aria-hidden="true" style="color:red;"></span>&nbsp;Cancelado</p>
                    <p><span class="glyphicon glyphicon-remove" aria-hidden="true" style="color:blue;"></span>&nbsp;Cancelado pelo Paciente</p>
                    <p><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true" style="color:red;"></span>&nbsp;Deficiente Auditivo</p>
                    <hr />
                    <p><button class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-list" aria-hidden="true"></span></button>&nbsp;&nbsp;Detalhes</p>
                    <p><button class="btn btn-xs btn-success"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>&nbsp;&nbsp;Aprovar Agendamento</p>
        ...
        <div class="col-md-9">
            ...
            <div id="tblAngedaProfissional" style="display:none;"></div>
        </div>
    </div>
    @push('scripts-footer')
        <script src="{{ asset('js/agenda/profissional.js') }}"></script>
    @endpush
@stop
