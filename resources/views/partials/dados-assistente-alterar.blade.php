...
<div class="form-group">
    ...
    <div class="col-md-3"> {{-- pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="Formato: 999.999.999-99" --}}
        <input type="text" class="form-control" name="txtCpf" placeholder="CPF" required value="{{ $dados['assistente']->cpf }}" />
    </div>
</div>
<div class="form-group">
    <label for="txtRg" class="col-md-2 control-label">RG</label>
    <div class="col-md-3">
        <input type="text" class="form-control" name="txtRg" placeholder="RG" required value="{{ $dados['assistente']->rg }}" />
    </div>
</div>
